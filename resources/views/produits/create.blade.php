                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('produits.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="reference" id="reference" value="{{ old('reference') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div class="mb-4">
