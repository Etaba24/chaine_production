<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 transition-colors duration-300">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Lien commun (Ouvrier, Chef, Admin) -->
                    <x-nav-link :href="route('ordres.mes_ordres')" :active="request()->routeIs('ordres.mes_ordres')">
                        {{ __('Mon Atelier') }}
                    </x-nav-link>

                    <!-- Liens réservés aux Chefs et Admins -->
                    @if(in_array(Auth::user()->role->nom, ['chef_atelier', 'admin']))
                        <x-nav-link :href="route('ordres.index')" :active="request()->routeIs('ordres.*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('ordres.mes_ordres')" :active="request()->routeIs('ordres.mes_ordres')">
                {{ __('Mon Atelier') }}
            </x-responsive-nav-link>

            @if(in_array(Auth::user()->role->nom, ['chef_atelier', 'admin']))
                <x-responsive-nav-link :href="route('ordres.index')" :active="request()->routeIs('ordres.*')">
                    {{ __('Gestion Production') }}
                </x-responsive-nav-link>
