            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('users.update', $user) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="password" class="block text-sm font-medium text-gray-700">Nouveau mot de passe <span class="text-xs text-gray-400">(laisser vide pour ne pas changer)</span></label>
